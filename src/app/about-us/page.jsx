...
=======
          <p>سلام، من مهبد هستم، یک توسعه‌دهنده وب با تمرکز بر رابط‌های کاربری زیبا و کاربردی. علاقه‌مند به طراحی و پیاده‌سازی پروژه‌های React و Next.js هستم و هدفم خلق تجربه‌های دیجیتال جذاب و مدرن برای کاربران است. در اینجا می‌توانید نمونه‌کارها و مهارت‌های من را ببینید و با من ارتباط برقرار کنید.</p>
